...
CREATE TABLE users (
    ...
    creation_date timestamp without time zone NOT NULL,
    quota bigint,
    qlimit bigint DEFAULT 53687091200::bigint
);
...
--
-- Name: i_container_node_node_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_container_node_node_oid ON container_node USING btree (node_oid);


--
-- Name: i_data_node_node_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_data_node_node_oid ON data_node USING btree (node_oid);


--
-- Name: i_group_node_property_node_property_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_group_node_property_node_property_oid ON group_node_property USING btree (node_property_oid);


--
-- Name: i_groups_group_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_groups_group_oid ON groups USING btree (group_oid);


--
-- Name: i_groups_manager; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_groups_manager ON groups USING btree (manager);


--
-- Name: i_link_node_node_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_link_node_node_oid ON link_node USING btree (node_oid);


--
-- Name: i_node_capability_capability_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_capability_capability_id ON node_capability USING btree (capability_id);


--
-- Name: i_node_capability_node_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_capability_node_id ON node_capability USING btree (node_id);


--
-- Name: i_node_name; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_name ON node USING btree (name);


--
-- Name: i_node_node_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_node_oid ON node USING btree (node_oid);


--
-- Name: i_node_owner_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_owner_id ON node USING btree (owner_id);


--
-- Name: i_node_parent_container_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_parent_container_id ON node USING btree (parent_container_id);


--
-- Name: i_node_property_node_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_property_node_id ON node_property USING btree (node_id);


--
-- Name: i_node_property_node_property_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_property_node_property_oid ON node_property USING btree (node_property_oid);


--
-- Name: i_node_property_property_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_property_property_id ON node_property USING btree (property_id);


--
-- Name: i_node_view_node_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_view_node_id ON node_view USING btree (node_id);


--
-- Name: i_node_view_view_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_node_view_view_id ON node_view USING btree (view_id);


--
-- Name: i_protocol_param_vo_protocol_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_protocol_param_vo_protocol_id ON protocol_param USING btree (vo_protocol_id);


--
-- Name: i_share_group_group_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_share_group_group_id ON share_group USING btree (group_id);


--
-- Name: i_share_group_node_property_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_share_group_node_property_id ON share_group USING btree (node_property_id);


--
-- Name: i_share_user_node_property_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_share_user_node_property_id ON share_user USING btree (node_property_id);


--
-- Name: i_share_user_user_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_share_user_user_id ON share_user USING btree (user_id);


--
-- Name: i_structured_data_node_node_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_structured_data_node_node_oid ON structured_data_node USING btree (node_oid);


--
-- Name: i_unstructured_data_node_node_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_unstructured_data_node_node_oid ON unstructured_data_node USING btree (node_oid);


--
-- Name: i_user_group_group_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_user_group_group_id ON user_group USING btree (group_id);


--
-- Name: i_user_group_user_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_user_group_user_id ON user_group USING btree (user_id);


--
-- Name: i_user_node_property_node_property_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_user_node_property_node_property_oid ON user_node_property USING btree (node_property_oid);


--
-- Name: i_users_name; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_users_name ON users USING btree (name);


--
-- Name: i_view_param_vo_view_id; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_view_param_vo_view_id ON view_param USING btree (vo_view_id);


--
-- Name: i_vo_capability_uri; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_vo_capability_uri ON vo_capability USING btree (uri);


--
-- Name: i_vo_capability_vo_capability_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_vo_capability_vo_capability_oid ON vo_capability USING btree (vo_capability_oid);


--
-- Name: i_vo_property_uri; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_vo_property_uri ON vo_property USING btree (uri);


--
-- Name: i_vo_property_vo_property_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_vo_property_vo_property_oid ON vo_property USING btree (vo_property_oid);


--
-- Name: i_vo_protocol_uri; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_vo_protocol_uri ON vo_protocol USING btree (uri);


--
-- Name: i_vo_protocol_vo_protocol_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_vo_protocol_vo_protocol_oid ON vo_protocol USING btree (vo_protocol_oid);


--
-- Name: i_vo_view_uri; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_vo_view_uri ON vo_view USING btree (uri);


--
-- Name: i_vo_view_vo_view_oid; Type: INDEX; Schema: vos; Owner: postgres; Tablespace: 
--

CREATE INDEX i_vo_view_vo_view_oid ON vo_view USING btree (vo_view_oid);
